...
public class StartupInstance : IStartupInstance
{
    ...
    public StartupInstance(DbInitSettings settings, FoodDeliveryDbContext dbContext)
    {
        _settings = settings;
    ...
    private static void ApplyEfCoreMigrations(FoodDeliveryDbContext dbContext)
    {
