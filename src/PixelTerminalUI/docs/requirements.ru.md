...
- Для того, чтобы не создавать тестовые данные для данного приложения с нуля, можно использовать скрипты, уже созданные в рамках проекта `UnifiedBusinessPlatform`.
