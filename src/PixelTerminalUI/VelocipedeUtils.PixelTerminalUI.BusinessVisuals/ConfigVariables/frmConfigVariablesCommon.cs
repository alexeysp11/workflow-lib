...
namespace VelocipedeUtils.PixelTerminalUI.BusinessVisuals.ConfigVariables;

public class frmConfigVariablesCommon : frmTerminalBase
{
    private TextControl? lblHeader;
    private TextControl? lblOperationName;
    private TextEditControl? txtUserInput;
    
    public frmConfigVariablesCommon() : base()
    {
    }
    
    protected override void InitializeComponent()
    {
        Name = nameof(frmConfigVariablesCommon);
        ...
        lblOperationName.Value = "CONFIGURATION VARIABLES. COMMON";
