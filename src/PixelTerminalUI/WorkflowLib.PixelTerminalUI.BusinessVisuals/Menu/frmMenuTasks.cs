...
{
    public frmMenuTasks() : base()
    {
    }
    
    protected override void InitializeComponent()
    {
        Name = nameof(frmMenuTasks);
        ...
        lblOperationName.Value = "MENU: TASKS";
        ...
        lblMenu02.Value = "2. SET RESPONSIBLE EMPLOYEE";
