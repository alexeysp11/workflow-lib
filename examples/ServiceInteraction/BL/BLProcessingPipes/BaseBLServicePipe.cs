...
/// <summary>
/// Pipe which is responsible for processing the request on the service side.
/// </summary>
public abstract class BaseBLServicePipe : AbstractProcessingPipe
{
    ...
    /// Default constructor.
    /// </summary>
    public BaseBLServicePipe(System.Action<IProcessingPipeDelegateParams> function) : base(function) {}
