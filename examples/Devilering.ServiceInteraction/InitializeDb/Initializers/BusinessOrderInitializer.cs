...
{
    /// <summary>
    // Business order initializer.
    /// </summary>
    public class BusinessOrderInitializer
    {
        ...
        /// Default constructor.
        /// </summary>
        public BusinessOrderInitializer(
        ...
        private void AddRecipes()
        {
            ...
            var ingredientProductIds = (from ingredient in context.Ingredients select ingredient.IngredientProduct.Id).ToList();
            var products = context.Products.Where(x => !ingredientProductIds.Any(i => i == x.Id)).ToList();
            
            foreach (var p in products)
            {
                sbInstruction.Append("Instruction #").Append(recipeNo.ToString());
                ...
                var recipe = new Recipe
                {
                    ...
                    Product = p,
                    Ingredients = context.Ingredients.Where(x => x.FinalProduct != null && x.FinalProduct.Id == p.Id).ToList(),
