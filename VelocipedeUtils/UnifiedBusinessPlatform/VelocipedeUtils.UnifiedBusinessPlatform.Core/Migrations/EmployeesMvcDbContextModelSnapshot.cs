...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.InformationSystem.Absense", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.InformationSystem.UserAccountGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.Languages.LanguageKey", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.Languages.LanguageKeyForm", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("WfApplicationFormId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("WfApplicationFormId");

                    b.ToTable("LanguageKeyForms");
                });

            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.Languages.LanguageKeyValuePair", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.WfAppInfo.WfApplication", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("WfApplication");
                });

            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.WfAppInfo.WfApplicationForm", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("WfApplicationId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("WfApplicationId");

                    b.ToTable("WfApplicationForm");
                });
            ...
            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.InformationSystem.UserAccountGroup", b =>
                {
                    ...
                    b.HasOne("VelocipedeUtils.Shared.Models.Business.InformationSystem.UserGroup", "UserGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.Languages.LanguageKeyForm", b =>
                {
                    b.HasOne("VelocipedeUtils.Shared.Models.Business.WfAppInfo.WfApplicationForm", "WfApplicationForm")
                        .WithMany()
                        .HasForeignKey("WfApplicationFormId");

                    b.Navigation("WfApplicationForm");
                });

            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.Languages.LanguageKeyValuePair", b =>
                {
                    b.HasOne("VelocipedeUtils.Shared.Models.Business.Languages.LanguageKey", "LanguageKey")
                        .WithMany()
            ...
            modelBuilder.Entity("VelocipedeUtils.Shared.Models.Business.WfAppInfo.WfApplicationForm", b =>
                {
                    b.HasOne("VelocipedeUtils.Shared.Models.Business.WfAppInfo.WfApplication", "WfApplication")
                        .WithMany()
                        .HasForeignKey("WfApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WfApplication");
                });
