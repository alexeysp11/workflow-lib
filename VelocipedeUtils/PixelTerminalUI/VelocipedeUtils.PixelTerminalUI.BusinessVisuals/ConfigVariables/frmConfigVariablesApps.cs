...
public class frmConfigVariablesApps : frmTerminalBase
{
    private TextControl? lblHeader;
    private TextControl? lblOperationName;
    private TextEditControl? txtUserInput;
    
    public frmConfigVariablesApps() : base()
    {
    }
    
    protected override void InitializeComponent()
    {
        Name = nameof(frmConfigVariablesApps);
        ...
        lblOperationName.Value = "CONFIGURATION VARIABLES. APPS";
