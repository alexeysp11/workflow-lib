...
namespace VelocipedeUtils.PixelTerminalUI.BusinessVisuals.Users;

public class frmUsersAccessRights : frmTerminalBase
{
    private TextControl? lblHeader;
    private TextControl? lblOperationName;
    private TextEditControl? txtUserInput;
    
    public frmUsersAccessRights() : base()
    {
    }
    
    protected override void InitializeComponent()
    {
        Name = nameof(frmUsersAccessRights);
        ...
        lblOperationName.Value = "USERS. ACCESS RIGHTS";
