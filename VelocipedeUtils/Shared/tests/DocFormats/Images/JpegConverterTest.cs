...
namespace Cims.Tests.VelocipedeUtils.Shared.Office.DocFormats.Images
{
    public class JpegConverterTest
    {
        ...
        private string FolderName = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), typeof(JpegConverterTest).ToString().Split('.').Last());
        ...
        public void TextToImg_OneOrMoreStringParamsEmpty_ReturnsException(bool isTextEmpty, bool isFoldernameEmpty, bool isFilenameEmpty)
        {
            ...
            string filename = isFilenameEmpty ? string.Empty : System.Reflection.MethodBase.GetCurrentMethod().Name + ".jpeg";

            IImageConverter converter = new JpegConverter();
        ...
        public void TextToImg_IncorrectFoldername_ReturnsException()
        {
            ...
            string filename = System.Reflection.MethodBase.GetCurrentMethod().Name + ".jpeg";
